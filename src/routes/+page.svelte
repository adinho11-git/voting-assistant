...
<section class="container-app home-hero pt-8 md:pt-14 pb-8 md:pb-12">
  ...
  <div class="hero-accent mb-8 max-w-3xl home-hero-copy">
    ...
    <h1 class="home-hero-title font-display text-ink mb-4">
      <span>Abstimmungen <span class="mobile-title-break">verstehen.</span></span>
      <span>Argumente <span class="mobile-title-break">gewichten.</span></span>
      <span>Eigene Position <span class="mobile-title-break">finden.</span></span>
    </h1>
